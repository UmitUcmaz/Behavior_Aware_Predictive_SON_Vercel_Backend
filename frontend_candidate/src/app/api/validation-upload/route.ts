...
import { uploadConstraints } from '../../../lib/validation-upload.mjs';
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return respond(400, 'Could not authorize actual CSV upload. Check the file type and size, then retry.');
  }
}
